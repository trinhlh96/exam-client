 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "http://service.examservice.example.com/", wsdlLocation = "http://localhost:8089/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("http://service.examservice.example.com/", "ProductServiceService");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://service.examservice.example.com/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.examservice.example.com/", "ProductServicePort"), ProductService.class, features);
    }
